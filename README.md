...
Provide comments explaining each function in the code (requires ongoing adjustments due to frequent updates).
...
✅ Creating a base Entity class to consolidate shared attributes between Player and Enemies, reducing code duplication and streamlining the addition of new adversaries.
...
Ex System: A system for the player to obtain experience in combats and level up.
